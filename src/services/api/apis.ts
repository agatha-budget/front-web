import { PersonApi, AccountApi, BudgetApi, AllocationApi, BudgetDataApi, OperationApi, CategoryApi, MasterCategoryApi, PostItApi } from './openApi/api'
...
export const postItApi = new PostItApi()
